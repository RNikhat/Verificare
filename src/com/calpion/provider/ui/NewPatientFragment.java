...
public class NewPatientFragment extends Fragment implements OnClickListener {
	EditText etfirst_name,etlast_name,etxage,etpolicy_id,eteffective_date,etxpriority,etxssno,etpinfo_phone,
	etemail,etemployer,etoffice_phone,etxphysician,etxnetwork,etxcity,etxstate,etxpayorid,etxinscompny,etinsrep,etpolicyno,
	etxgroupno,etinsphone;
...
/*		etpolicy_id=(EditText)getActivity().findViewById(R.id.etpolicyid);
		eteffective_date=(EditText)getActivity().findViewById(R.id.eteffectivedate);
		...
		etoffice_phone=(EditText)getActivity().findViewById(R.id.etofficephone);
		...
		etxinscompny=(EditText)getActivity().findViewById(R.id.etinsurancecmpny);
		...
		tvpolicyeff=(TextView)getActivity().findViewById(R.id.etpolicyeffective);
		tvpolicyend=(TextView)getActivity().findViewById(R.id.etpolicyending);
		tvdob.setOnClickListener(this);
		tvappntmnt.setOnClickListener(this);
